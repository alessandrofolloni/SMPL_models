...
class PreProcessor(object):
    ...
    def __init__(self, unsqueeze, device):
        # type: (bool, str) -> None
        """
        :param unsqueeze: unsqueeze output tensor so that it has singleton
            dimension at the beginning => (1,C,H,W)
    ...
    def apply(self, img):
        ...
        :return: torch tensor with shape (C,H,W) or (1,C,H,W) and values
            in range [0,1]
        """
